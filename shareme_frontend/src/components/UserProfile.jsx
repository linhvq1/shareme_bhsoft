...
const randomImage =
  "https://source.unsplash.com/1600x900/?nature,phography,technology";
...
function UserProfile() {
  ...
  useEffect(() => {
    ...
    let query =
      text === "Created"
        ? userCreatedPinsQuery(userId, sortedBy, owner)
        : userSavedPinsQuery(userId, sortedBy, owner);
    client.fetch(query).then((data) => {
      setPins(data);
      setReloadPin(false);
    });
        ...
        <div className="relative flex flex-col mb-7">
          ...
          {pins?.length ? (
            <div className="px-2">
              <div
                className={
                  isActive ? isActiveStyleFloatBtn : isNotActiveStyleFloatBtn
                }
